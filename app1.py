...
seating_capacity = st.sidebar.slider('Seating Capacity', 2, 200, 1)
average_meal_price = st.sidebar.slider('Average Meal Price', 50.0, 2000.0, 1.0)
social_media_followers = st.sidebar.slider('Social Media Followers', 0, 100000, 1)
chef_experience_years = st.sidebar.slider('Chef Experience Years', 0, 50, 1)
